...
const Employnav = () => {
  ...
  return (
   <div className="bg-transparent backdrop-blur-lg border-b border-slate-800 fixed top-0 w-full text-white flex justify-between items-center px-6 md:px-12 py-4 z-50 shadow-lg">
        <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-3">
